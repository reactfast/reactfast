export const themeInfo = {
  ...
  font_color: '#ffffff',
  bg_image:
    'https://gjicrqpogkzojcniixqi.supabase.co/storage/v1/object/public/images/jot-backgrounds/01.jpg',
}
  ...
  const Sections = [
    ...
    },
    {
      ...
      definition: {
        iconBg: '#424242',
        threads: '',
        twitter: 'https://x.com/JonathonMcClen',
        linkedin: 'https://www.linkedin.com/in/jonathonmcclen/',
        instagram: 'https://www.instagram.com/bootcamp.boi.io/',
      },
      sec_type: {
        id: 16,
        num: null,
