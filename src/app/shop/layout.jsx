...
import { getUniqueItemCount } from '@/helpers/cart'
...
export default function ShopNav({ children }) {
  ...
  useEffect(() => {
    if (isBrowser) {
      setItemCount(getUniqueItemCount())
    }
  }, [])
        ...
        >
          <div className="border-b border-gray-200">
            <div className="flex h-16 items-center justify-between">
              ...
              {/* Flyout menus */}
              <div className="hidden lg:block lg:flex-1 lg:self-stretch"></div>

              {/* Logo */}
              <a href="/" className="flex h-auto w-20">
                <span className="sr-only">Jot</span>
                <Logo />
              </a>
