...
export default function GuidedTour() {
  ...
  // Function to create the cookie with the value "v1.0"
  function setCookie() {
    if (typeof document !== 'undefined') {
      document.cookie = 'jot-builder-joyride=v1.0; path=/; max-age=31536000' // Expires in 1 year
    }
  }

  // Check if the cookie exists and skip the modal if it does
  useEffect(() => {
    if (checkCookie()) {
      setShowModal(false)
    }
  ...
  const handleJoyrideCallback = (data) => {
    ...
    if (status === 'finished' || status === 'skipped') {
      ...
      setCookie() // Set the cookie to prevent future tours
    }
  }
