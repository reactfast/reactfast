...
import { ArrowBigLeft, PawPrint } from 'lucide-react'
...
export default function Example({ children }) {
  ...
  const [dynamicNavigation, setDynamicNavigation] = useState([
    { name: 'Dashboard', href: '/account/admin/crmini', icon: ChartBarIcon },
    {
      name: 'Customers',
      href: '/account/admin/crmini/customers',
      icon: UserGroupIcon,
    },
    { name: 'Email', href: '/account/admin/crmini/email', icon: EnvelopeIcon },
    {
      name: 'Tickets',
      href: '/account/admin/crmini/tickets',
      icon: TicketIcon,
    },
    {
      name: 'Calendar',
      href: '/account/admin/crmini/calendar',
      icon: CalendarDaysIcon,
    },
    {
      name: 'Chat',
      href: '/account/admin/crmini/chat',
      icon: ChatBubbleLeftRightIcon,
    },
    { name: 'Settings', href: '/account/admin/crmini/settings', icon: CogIcon },
  ])
    ...
    <>
      <div>
            ...
            <div className="mt-4 flex h-16 shrink-0 items-center">
              <Link href="/" className="flex items-center gap-x-4">
                <h1 className="text-3xl font-black">
                  CR<span className="font-light">Mini</span>
                </h1>
              </Link>
            </div>
            <nav className="flex flex-1 flex-col">
                ...
                <li className="-mx-6 mt-auto">
                  ...
                  >
                    <ArrowBigLeft
                      ...
                      aria-hidden="true"
                    />
                    <span aria-hidden="true">Back To Jot</span>
                  </a>
                </li>
              </ul>
            </nav>
        ...
        <div className="sticky top-0 z-40 flex items-center gap-x-6 border-b-2 border-primary bg-white px-4 py-4 text-primary shadow-sm sm:px-6 lg:hidden">
          ...
          <Link href="/account">
            <span className="sr-only">Back To Jot</span>
            <UserCircleIcon
              className="size-8 text-primary"
              aria-hidden="true"
            />
