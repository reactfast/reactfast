...
export default function Example() {
  return (
    <div className="lg:flex lg:h-full lg:flex-col">
      ...
      <div className="shadow ring-1 ring-black/5 lg:flex lg:flex-auto lg:flex-col dark:shadow-none dark:ring-white/5">
          ...
          <div className="hidden w-full lg:grid lg:grid-cols-7 lg:grid-rows-6 lg:gap-px">
            {days.map((day) => (
              ...
              >
                <time
                  dateTime={day.date}
                  className="relative group-[:not([data-is-current-month])]:opacity-75 [[data-is-today]_&]:flex [[data-is-today]_&]:size-6 [[data-is-today]_&]:items-center [[data-is-today]_&]:justify-center [[data-is-today]_&]:rounded-full [[data-is-today]_&]:bg-indigo-600 [[data-is-today]_&]:font-semibold [[data-is-today]_&]:text-white dark:[[data-is-today]_&]:bg-indigo-500"
                >
          ...
          <div className="isolate grid w-full grid-cols-7 grid-rows-6 gap-px lg:hidden">
            {days.map((day) => (
              ...
              >
                <time
                  dateTime={day.date}
                  className="ml-auto group-[:not([data-is-current-month])]:opacity-75 [[data-is-selected]_&]:flex [[data-is-selected]_&]:size-6 [[data-is-selected]_&]:items-center [[data-is-selected]_&]:justify-center [[data-is-selected]_&]:rounded-full [[data-is-selected]_&]:[&:not([data-is-today]_*)]:bg-gray-900 dark:[[data-is-selected]_&]:[&:not([data-is-today]_*)]:bg-white dark:[[data-is-selected]_&]:[&:not([data-is-today]_*)]:text-gray-900 [[data-is-selected]_&]:[[data-is-today]_&]:bg-indigo-600 dark:[[data-is-selected]_&]:[[data-is-today]_&]:bg-indigo-500"
                >
                  {day.date.split('-').pop().replace(/^0/, '')}
                </time>
      ...
      <div className="relative px-4 py-10 sm:px-6 lg:hidden dark:after:pointer-events-none dark:after:absolute dark:after:inset-x-0 dark:after:top-0 dark:after:h-px dark:after:bg-white/10">
        <ol className="divide-y divide-gray-100 overflow-hidden rounded-lg bg-white text-sm shadow outline outline-1 outline-black/5 dark:divide-white/10 dark:bg-gray-800/50 dark:shadow-none dark:-outline-offset-1 dark:outline-white/10">
          {events.map((event) => (
            <li
              key={event.id}
